...
window.scriptManagerDesktop = {
  ...
  runtime: {
    ...
    listApiAssertions: (requestId: string) => invokeTauri('list_api_assertions', { requestId }),
    listDataSets: () => invokeTauri('list_data_sets'),
    saveDataSet: (payload: unknown) => invokeTauri('save_data_set', { payload: payload as Record<string, unknown> }),
    deleteDataSet: (id: string) => invokeTauri('delete_data_set', { id }),
    ...
    listMockServers: () => invokeTauri('mock_server_status'),
    saveMockServer: (payload: unknown) => invokeTauri('save_mock_server', { payload: payload as Record<string, unknown> }),
    deleteMockServer: (id: string) => invokeTauri('delete_mock_server', { id }),
    startMockServer: (id: string) => invokeTauri('start_mock_server', { id }),
    stopMockServer: (id: string) => invokeTauri('stop_mock_server', { id }),
    listMockRequests: (serverId: string) => invokeTauri('list_mock_requests', { serverId }),
    clearMockRequests: (serverId: string) => invokeTauri('clear_mock_requests', { serverId }),
