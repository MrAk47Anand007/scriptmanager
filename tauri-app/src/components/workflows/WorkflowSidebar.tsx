...
import { ChevronLeft, ChevronRight, ClipboardCopy, ClipboardPaste, GitBranch, Plus, Sparkles } from 'lucide-react'
...
export function WorkflowSidebar() {
  const dispatch=useAppDispatch();const items=useAppSelector(selectWorkflows);const active=useAppSelector(selectActiveWorkflow);const [collapsed,setCollapsed]=useState(false);const [importOpen,setImportOpen]=useState(false);const [importText,setImportText]=useState('');const [generateOpen,setGenerateOpen]=useState(false)
