...
const slice = createSlice({
  ...
  reducers: {
    ...
    setWorkflowProject(state, action: PayloadAction<string | null>) { if (state.active) { state.active.projectId = action.payload; state.dirty = true } },
...
export const { selectWorkflow, selectNode, addNode, updateNodeConfig, setWorkflowProject, connectNodes, setValidation } = slice.actions
