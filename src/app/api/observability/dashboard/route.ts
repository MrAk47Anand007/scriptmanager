...
export async function GET(request: Request) {
  ...
  try { return Response.json(await observabilityRepository.getDashboard({ ...parseExecutionFilters(new URL(request.url).searchParams), workspaceId: authorization.context.workspaceId })) }
