...
contextBridge.exposeInMainWorld('scriptManagerDesktop', {
  ...
  runtime: {
    ...
    listNotificationDeliveries: (since?: string) => ipcRenderer.invoke('scriptmanager:runtime:list-notification-deliveries', since) as Promise<unknown[]>,
    ...
    listAgentProfiles: () => ipcRenderer.invoke('scriptmanager:runtime:list-agent-profiles') as Promise<unknown[]>,
